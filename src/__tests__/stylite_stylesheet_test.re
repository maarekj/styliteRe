      ...
      describe
        ...
        (
          fun () => {
            ...
            test "listener1 is called" (fun () => expect !listener1_is_called |> toEqual true);
            test "listener2 is called" (fun () => expect !listener2_is_called |> toEqual true);
            test "listener3 not is called" (fun () => expect !listener3_is_called |> toEqual false)
          }
        )
    }
  );